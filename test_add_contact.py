...
class TestAddContact(unittest.TestCase):
    ...
    def open_home_page(self, wd):
        wd.get("http://macbook-pro-elvira.local/addressbook/edit.php")
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstName="Anna", lastName="Petrova", nickname="annapetr", company="First Company Anna", address="Moscow, Nikitskaya 22", phone_home="111",
